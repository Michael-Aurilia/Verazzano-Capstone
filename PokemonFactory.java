...
public class PokemonFactory {
	public static Swampert createSwampert() {
        ...
        String info = "A brutal Pokémon with pressurized water jets on its shell. They are used for high-speed tackles.";
        return new Swampert(207, "Swampert", "Water", "Ground", moves, battleCry, 178, 156, 150, 172, 143, info);
	}
	
	public static Jolteon createJolteon() {
		List<String> moves = Arrays.asList("Thunderbolt", "Hyper Voice", "Shadow Ball", "Doubl Kick");
		...
		return new Jolteon(172, "Jolteon", "Electric", "Null", moves, battleCry, 128, 152, 178, 161, 200, info);
	}
	...
	public static Garchomp createGarchomp() {
		...
		return new Garchomp(215, "Garchomp", "Dragon", "Ground", moves, battleCry, 200, 161, 145, 150, 169, info);
	}
	...
	public static Roserade createRoserade() {
		...
		return new Roserade(167, "Roserade", "Grass", "Poison", moves, battleCry, 134, 128, 194, 172, 156, info);
	}
	...
	public static Milotic createMilotic() {
		...
		String battleCry = "Roar!";
		return new Milotic(202, "Milotic", "Water", "Null", moves, battleCry, 123, 144, 167, 194, 146, info);
	}
	...
	public static Lucario createLucario() {
		...
		String battleCry = "Roar!";
		return new Lucario(177, "Lucario", "Fighting", "Steel", moves, battleCry, 178, 134, 183, 134, 156, info);
	}
	...
	public static Togekiss createTogekiss() {
		...
		return new Togekiss(192, "Togekiss", "Fairy", "Flying", moves, battleCry, 112, 161, 189, 183, 145, info);
	}
	...
	public static Spiritomb createSpiritomb() {
		...
		return new Spiritomb(157, "Spiritomb", "Ghost", "Dark", moves, battleCry, 158, 176, 158, 176, 95, info);
	}
	...
	public static Staraptor createStaraptor() {
		...
		return new Staraptor(192, "Staraptor", "Normal", "Flying", moves, battleCry, 189, 134, 112, 123, 167, info);
	}
	...
	public static Abomasnow createAbomasnow() {
		...
		String battleCry = "Roar!";
		return new Abomasnow(167, "Abomasnow", "Grass", "Ice", moves, battleCry, 117, 156, 216, 156, 145, info);
	}
	...
	public static Chandelure createChandelure() {
		...
		return new Chandelure(192, "Chandelure", "Ghost", "Fire", moves, battleCry, 112, 161, 189, 183, 145, info);
	}
	...
	public static Metagross createMetagross() {
		...
		String battleCry = "Roar!";
		return new Metagross(187, "Metagross", "Steel", "Psychic", moves, battleCry, 205, 200, 161, 156, 134, info);
	}
}