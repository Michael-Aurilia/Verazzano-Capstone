...
public class Metagross extends Pokemon{
	...
	public Metagross(int hp, String name, String type1, String type2, List<String> attacks, String bc, double atk, double def, double spAtk, double spDef, double spe, String info) {
	...
	public void attack(Pokemon other, int attackIndex) {
		...
		//Creates attacks for this Pokemon to use.
				...
				Metagross Meta = new Metagross(187, "Metagross", "Steel", "Psychic", moves12, battleCry12, 205, 200, 161, 156, 134, PokemonInfo12);
