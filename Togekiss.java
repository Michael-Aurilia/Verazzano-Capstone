...
public class Togekiss extends Pokemon{
	...
	public Togekiss(int hp, String name, String type1, String type2, List<String> attacks, String bc, double atk, double def, double spAtk, double spDef, double spe, String info) {
	...
	public void attack(Pokemon other, int attackIndex) {
		...
		//Creates attacks for this Pokemon to use.
				...
				Togekiss Kiss = new Togekiss(192, "Togekiss", "Fairy", "Flying", moves7, battleCry7, 112, 161, 189, 183, 145, PokemonInfo7);
