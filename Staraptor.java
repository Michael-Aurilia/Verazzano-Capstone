...
public class Staraptor extends Pokemon{
	...
	public Staraptor(int hp, int mhp, String status, String name, String type1, String type2, List<Attack> attacks, String bc, double atk, double def, double spAtk, double spDef, double spe, String info) {
	...
	public void attack(Pokemon myPokemon, Pokemon other, int attackIndex) {
		...
		if (attackIndex == 1) {
			System.out.println("Staraptor used Brave Bird!");
			...
			System.out.println("Staraptor used Facade!");
			if (myPokemon.getStatus() != "Healthy") {
				damageDealt = (myPokemon.getAttacks().get(1).getDamage(myPokemon.getAttacks().get(1), myPokemon, other)) * 2;
			}
			else{
			...
			remainingHP = other.getHitPoints() - damageDealt;
			other.setHitPoints(remainingHP);
			if (myPokemon.getAttacks().get(1).getDamageMultiplier(myPokemon.getAttacks().get(1).getAttackType(), other) == 0) {
				System.out.println("The move had no effect.");
			}
			...
			System.out.println("Staraptor used Close Combat!");
			...
			System.out.println("Staraptor used Endeavor!");
			if (myPokemon.getAttacks().get(3).getDamageMultiplier(myPokemon.getAttacks().get(3).getAttackType(), other) == 0) {
				System.out.println("The move had no effect.");
