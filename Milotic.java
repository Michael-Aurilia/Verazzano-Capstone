...
public class Milotic extends Pokemon{
	...
	public List<Integer> getDamages(Pokemon myPokemon, Pokemon other){
		...
		int damageDealt1 = Surf.getDamage(Surf, MLTC, other);
		int damageDealt2 = IceBeam.getDamage(IceBeam, MLTC, other);
		int damageDealt3 = DragonPulse.getDamage(DragonPulse, MLTC, other);
		int damageDealt4 = WaterPulse.getDamage(WaterPulse, MLTC, other);
